...
# NOTE: the daily/incremental sync_user_data() used to live here too.
# That copy was never called (services/sync_engine.py always imported
# sync_user_data from normal_sync.py, not from bot.py) — removed as a
# dead duplicate. normal_sync.sync_user_data() is the single source of
# truth for daily/incremental sync; this file keeps the functions
# sync_engine.py actually re-exports: get_dashboard_data,
# generate_daily_challenges, create_user_sheet, import_lc_full.
